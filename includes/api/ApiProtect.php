...
class ApiProtect extends ApiBase {
	...
	public function execute() {
		...
		$title_restrictions = new TitleRestrictions( $titleObj );
		$restrictionTypes = $title_restrictions->getRestrictionTypes();
		...
		$status = $title_restrictions->doUpdateRestrictions( $protections, $expiryarray, $cascade, $params['reason'], $this->getUser() );
